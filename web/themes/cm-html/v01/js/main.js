!(function (e) {
  ...
  var v = "[data-sec-pos]";
  e(v).length && e(v).sectionPosition("data-sec-pos", "data-pos-for"),
    e(".circle-progress")
      .circleProgress({
        size: 110,
        thickness: 8,
    ...
    e(".vs-slider-tab").length &&
      e(".vs-slider-tab").vsTab({ sliderTab: !0, tabButton: ".tab-btn" }),
  ...
  g
    .on("init", function (t, s, a) {
      ...
      e(`.testi-nav .tab-btn[data-goto="${o}"]`).addClass("active"),
        e(`.testi-nav .tab-btn[data-goto="${r}"]`).addClass("next"),
        e(`.testi-nav .tab-btn[data-goto="${i}"]`).addClass("prev"),
        (s.$prevIndex = i),
        (s.$nextIndex = r);
    })
    .on("beforeChange", function (t, s, a, n) {
      ...
      e(`.testi-nav .tab-btn[data-goto="${s.$prevIndex}"]`).removeClass("prev"),
        e(`.testi-nav .tab-btn[data-goto="${s.$nextIndex}"]`).removeClass(
          "next"
        );
      var r = o.prev().data("slick-index"),
        l = o.next().data("slick-index");
      e(`.testi-nav .tab-btn[data-goto="${l}"]`).addClass("next"),
        e(`.testi-nav .tab-btn[data-goto="${r}"]`).addClass("prev"),
        (s.$prevIndex = r),
        (s.$nextIndex = l),
        e(`.testi-nav .tab-btn[data-goto="${i}"]`)
          .addClass("active")
          .removeClass("next")
          .removeClass("prev")
          .siblings()
