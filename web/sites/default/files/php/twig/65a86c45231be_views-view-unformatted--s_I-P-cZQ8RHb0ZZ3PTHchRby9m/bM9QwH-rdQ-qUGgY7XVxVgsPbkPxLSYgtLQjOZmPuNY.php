...
/* themes/custom/solar/templates/views/views-view-unformatted--suggestedgreenprojects.html.twig */
class __TwigTemplate_0436cef6dafdb51d1e98c924a77ee027 extends Template
{
    private $source;
    private $macros = [];
...
($context["default_row_class"] ?? null)) ? ("views-row col-lg-6 col-md-6 col-sm-6 col-12") : (""))];
            // line 29
            echo "  <div";
...
";
    ...
    {
        return "themes/custom/solar/templates/views/views-view-unformatted--suggestedgreenprojects.html.twig";
    }
...
{% for row in rows %}
  {%
    set row_classes = [
      default_row_class ? 'views-row col-lg-6 col-md-6 col-sm-6 col-12',
    ]
  %}
...
{% endfor %}
", "themes/custom/solar/templates/views/views-view-unformatted--suggestedgreenprojects.html.twig", "/var/www/html/adn.id.vn/d10test/web/themes/custom/solar/templates/views/views-view-unformatted--suggestedgreenprojects.html.twig");
    }
