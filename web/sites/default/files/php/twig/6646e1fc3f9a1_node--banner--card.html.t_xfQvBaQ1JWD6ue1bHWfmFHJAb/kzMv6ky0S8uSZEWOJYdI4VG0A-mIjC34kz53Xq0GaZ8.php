...
($context["view_mode"] ?? null)) ? (("node--view-mode-" . \Drupal\Component\Utility\Html::getClass($this->sandbox->ensureToStringAllowed(($context["view_mode"] ?? null), 82, $this->source)))) : (""))];
          ...
          <div class=\"row\">
            ...
            echo "\" title=\"CME Solar\" frameborder=\"0\" allow=\"accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share\" allowfullscreen></iframe>
                      ...
                      <div class=\"button-solari-banner-area\">                      
                          <a href=\"";
            // line 145
            echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed((($__internal_compile_0 = twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["content"] ?? null), "field_lean_more", [], "any", false, false, true, 145), 0, [], "any", false, false, true, 145)) && is_array($__internal_compile_0) || $__internal_compile_0 instanceof ArrayAccess ? ($__internal_compile_0["#url"] ?? null) : null), 145, $this->source), "html", null, true);
            echo "\" class=\"rts-btn btn-primary\">";
            echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed((($__internal_compile_1 = twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["content"] ?? null), "field_lean_more", [], "any", false, false, true, 145), 0, [], "any", false, false, true, 145)) && is_array($__internal_compile_1) || $__internal_compile_1 instanceof ArrayAccess ? ($__internal_compile_1["#title"] ?? null) : null), 145, $this->source), "html", null, true);
            echo "</a>
                          <div class=\"vedio-icone d-none\">
                              <a class=\"video-play-button play-video-banner-";
            // line 147
            echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, ($context["node"] ?? null), "id", [], "any", false, false, true, 147), 147, $this->source), "html", null, true);
            echo "\" href=\"#\">
                                  <span></span>
                                  <p class=\"text\">
                                      ";
  ...
  ";
    ...
    {
        return array (  189 => 164,  172 => 150,  166 => 147,  159 => 145,  153 => 142,  149 => 141,  144 => 139,  139 => 137,  134 => 135,  125 => 129,  118 => 128,  106 => 119,  101 => 117,  96 => 115,  85 => 107,  73 => 99,  71 => 98,  56 => 85,  54 => 82,  53 => 81,  52 => 80,  51 => 79,  50 => 78,  49 => 77,  48 => 76,  47 => 73,  44 => 71,  42 => 70,  39 => 69,);
    }
    ...
    public function checkSecurity()
    {
        ...
        static $filters = array("clean_class" => 70, "escape" => 99, "raw" => 117, "trim" => 142, "striptags" => 142, "render" => 142, "t" => 150);
