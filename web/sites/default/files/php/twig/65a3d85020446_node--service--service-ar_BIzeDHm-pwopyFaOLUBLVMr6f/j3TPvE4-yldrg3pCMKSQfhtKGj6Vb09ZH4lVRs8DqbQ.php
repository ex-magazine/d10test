...
class __TwigTemplate_d9038dea8df4ad3fe98c2de3b883bbd2 extends Template
{
    private $source;
    private $macros = [];
...
<article{{ attributes.addClass(classes) }}>
  <div class=\"single-solari-service-start\" style=\"background-image: url('{{ file_url(node.field_image.entity.fileuri) }}');\">
      <div class=\"icon-area\">
        {{ content.field_svg|raw }}
      </div>
      ...
      <a href=\"{{ url }}\" rel=\"bookmark\" class=\"read-more-btn\">{{ 'Read More'|t }}<i class=\"fa-regular fa-arrow-right\"></i></a>
  </div>
</article>
", "themes/custom/solar/templates/content/node--service--service-area.html.twig", "/var/www/html/adn.id.vn/d10test/web/themes/custom/solar/templates/content/node--service--service-area.html.twig");
    }
