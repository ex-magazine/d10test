...
class __TwigTemplate_10a91a558757bb4ba7e5c8eb733f8909 extends Template
{
    private $source;
    private $macros = [];
...
<div{{ attributes.addClass(classes) }}>
  ...
  {% if label %}
    <div class=\"wized-header\">
        <h5{{ title_attributes.addClass('title') }}>{{ label }}</h5>
    </div>
  {% endif %}
  {{ title_suffix }}
  {% block content %}
...
", "themes/custom/solar/templates/block/block--solar-menuaboutus.html.twig", "/var/www/html/adn.id.vn/d10test/web/themes/custom/solar/templates/block/block--solar-menuaboutus.html.twig");
    }
