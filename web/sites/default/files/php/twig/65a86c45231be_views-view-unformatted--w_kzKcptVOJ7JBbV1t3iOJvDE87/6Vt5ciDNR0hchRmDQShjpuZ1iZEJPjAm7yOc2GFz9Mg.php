...
/* themes/custom/solar/templates/views/views-view-unformatted--whatcustomerssays.html.twig */
class __TwigTemplate_33c109fdbdb0a2c13ead71d5354fdef3 extends Template
{
    private $source;
    private $macros = [];
...
($context["default_row_class"] ?? null)) ? ("views-row col-lg-4") : (""))];
            // line 29
            echo "  <div";
...
";
    ...
    {
        return "themes/custom/solar/templates/views/views-view-unformatted--whatcustomerssays.html.twig";
    }
...
{% for row in rows %}
  {%
    set row_classes = [
      default_row_class ? 'views-row col-lg-4',
    ]
  %}
...
{% endfor %}
", "themes/custom/solar/templates/views/views-view-unformatted--whatcustomerssays.html.twig", "/var/www/html/adn.id.vn/d10test/web/themes/custom/solar/templates/views/views-view-unformatted--whatcustomerssays.html.twig");
    }
