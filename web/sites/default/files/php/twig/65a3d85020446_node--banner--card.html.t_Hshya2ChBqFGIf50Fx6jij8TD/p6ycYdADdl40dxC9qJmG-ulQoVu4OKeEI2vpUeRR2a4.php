...
class __TwigTemplate_716593c230467eeed2d258ed96248236 extends Template
{
    private $source;
    private $macros = [];
...
%}
<div{{ attributes.addClass(classes) }} style=\"background-image: url('{{ file_url(node.field_image.entity.fileuri) }}');\">

  <span class=\"water-text images\"> {{ content.field_position|raw }}</span>
  <div class=\"container\">
      <div class=\"row\">
          <div class=\"col-lg-6\">
              <div class=\"banner-solari-2-content ptb--200 ptb_sm--130\">                  
                  {{ content.field_title_second|raw }}
                  <h2 class=\"banner-title\">
                      {{ label }}
                  </h2>                  
                  <div class=\"disc\">
                  ...
                  <div class=\"button-solari-banner-area\">                      
                      <a href=\"{{ content.field_lean_more.0['#url'] }}\" class=\"rts-btn btn-primary\">{{ content.field_lean_more.0['#title'] }}</a>
                      <div class=\"vedio-icone\">
                          <a class=\"video-play-button play-video\" href=\"#\">
                              <span></span>
                              <p class=\"text\">
                    ...
                    ", "themes/custom/solar/templates/content/node--banner--card.html.twig", "/var/www/html/adn.id.vn/d10test/web/themes/custom/solar/templates/content/node--banner--card.html.twig");
    }
