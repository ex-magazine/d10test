...
/* themes/custom/solar/templates/content/node--landingpage--faq.html.twig */
class __TwigTemplate_2c88414f860e7f57324d6f7378fefb93 extends Template
{
    private $source;
    private $macros = [];
        ...
        <div class=\"container\">
            <div class=\"row\"> 
                <div class=\"col-lg-8\">
                    ";
        // line 119
        echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, ($context["content"] ?? null), "field_paragraphs", [], "any", false, false, true, 119), 119, $this->source), "html", null, true);
        echo "
                    ";
        // line 120
        echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, ($context["content"] ?? null), "field_viewreference", [], "any", false, false, true, 120), 120, $this->source), "html", null, true);
        echo "                     
                </div>
                <div class=\"col-lg-4 pl--30 pl_md--10 pl_sm--10\">                  
                     ";
        // line 123
        echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, Drupal\twig_tweak\TwigTweakExtension::drupalEntity("block", "solar_faqcallusnow"), "html", null, true);
        echo "
                </div>
            </div>
        </div>
...
";
    ...
    {
        return "themes/custom/solar/templates/content/node--landingpage--faq.html.twig";
    }
    ...
    {
        return array (  140 => 123,  134 => 120,  130 => 119,  109 => 103,  105 => 102,  99 => 101,  94 => 98,  86 => 97,  78 => 95,  76 => 94,  71 => 92,  62 => 86,  56 => 84,  54 => 81,  53 => 80,  52 => 79,  51 => 78,  50 => 77,  49 => 76,  48 => 75,  47 => 73,  44 => 71,  42 => 70,  39 => 69,);
    }

    public function getSourceContext()
    {
        return new Source("", "themes/custom/solar/templates/content/node--landingpage--faq.html.twig", "/var/www/html/adn.id.vn/d10test/web/themes/custom/solar/templates/content/node--landingpage--faq.html.twig");
    }
    
    public function checkSecurity()
    {
        static $tags = array("set" => 70, "if" => 94, "trans" => 101);
        static $filters = array("clean_class" => 70, "escape" => 84, "trim" => 94, "striptags" => 94, "render" => 94);
        static $functions = array("file_url" => 86, "drupal_entity" => 123);
