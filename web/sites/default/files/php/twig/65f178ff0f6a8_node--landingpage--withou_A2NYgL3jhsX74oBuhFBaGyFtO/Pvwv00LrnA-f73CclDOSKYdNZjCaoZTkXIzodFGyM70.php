...
/* themes/custom/solar/templates/content/node--landingpage--withoutsidebar.html.twig */
class __TwigTemplate_0ac6fa5b8c63456256df3240514b143a extends Template
{
    private $source;
    private $macros = [];
...
($context["view_mode"] ?? null)) ? (("node--view-mode-" . \Drupal\Component\Utility\Html::getClass($this->sandbox->ensureToStringAllowed(($context["view_mode"] ?? null), 81, $this->source)))) : (""))];
    ...
    <div class=\"container pb--160\">
        ";
        // line 115
        if ( !twig_test_empty(twig_get_attribute($this->env, $this->source, ($context["content"] ?? null), "field_paragraphs", [], "any", false, false, true, 115))) {
            // line 116
            echo "            ";
            echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, ($context["content"] ?? null), "field_paragraphs", [], "any", false, false, true, 116), 116, $this->source), "html", null, true);
            echo "
        ";
        }
        // line 118
        ...
        ";
        // line 120
        if ( !twig_test_empty(twig_get_attribute($this->env, $this->source, ($context["content"] ?? null), "field_roofspacearea", [], "any", false, false, true, 120))) {
            // line 121
            echo "            ";
            echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, ($context["content"] ?? null), "field_roofspacearea", [], "any", false, false, true, 121), 121, $this->source), "html", null, true);
            echo "
        ";
        }
        // line 123
...
";
    ...
    {
        return "themes/custom/solar/templates/content/node--landingpage--withoutsidebar.html.twig";
    }
    ...
    {
        return array (  150 => 127,  144 => 123,  138 => 121,  136 => 120,  132 => 118,  126 => 116,  124 => 115,  107 => 103,  103 => 102,  99 => 101,  94 => 98,  86 => 97,  78 => 95,  76 => 94,  71 => 92,  62 => 86,  56 => 84,  54 => 81,  53 => 80,  52 => 79,  51 => 78,  50 => 77,  49 => 76,  48 => 75,  47 => 73,  44 => 71,  42 => 70,  39 => 69,);
    }

    public function getSourceContext()
    {
        return new Source("", "themes/custom/solar/templates/content/node--landingpage--withoutsidebar.html.twig", "/var/www/html/adn.id.vn/d10test/web/themes/custom/solar/templates/content/node--landingpage--withoutsidebar.html.twig");
    }
    ...
    public function checkSecurity()
    {
        ...
        static $functions = array("file_url" => 86, "drupal_region" => 127);
