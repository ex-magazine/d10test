...
class __TwigTemplate_4d5d404c94694011002beaa7a5a435d3 extends Template
{
    private $source;
    private $macros = [];
...
{%
  set classes = [
    'view',
    'rts-customers-says-area rts-section-gapTop bg_image bg-testimonials-1 reveal',
    'view-' ~ id|clean_class,
    'view-id-' ~ id,
...
<div{{ attributes.addClass(classes) }}>
  ...
  {% if rows %}
      <div class=\"row g-24 pb--110 mt--10\">     
            {{ rows }}        
      </div>
  {% elseif empty %}
...
", "themes/custom/solar/templates/views/views-view--whatcustomerssays.html.twig", "/var/www/html/adn.id.vn/d10test/web/themes/custom/solar/templates/views/views-view--whatcustomerssays.html.twig");
    }
