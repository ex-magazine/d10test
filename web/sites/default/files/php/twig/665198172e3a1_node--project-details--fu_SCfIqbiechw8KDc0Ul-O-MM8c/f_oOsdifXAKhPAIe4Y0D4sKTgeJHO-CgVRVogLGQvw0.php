...
class __TwigTemplate_368953dea85416ec3139c10683958c4b extends Template
{
    private $source;
    private $macros = [];
...
<article";
    ...
    <div class=\"row\">
        ...
        if ((twig_trim_filter(twig_striptags($this->extensions['Drupal\Core\Template\TwigExtension']->renderVar(twig_get_attribute($this->env, $this->source, ($context["content"] ?? null), "field_pcategory", [], "any", false, false, true, 97)))) == "video")) {
            ...
            echo "\" title=\"CME Solar\" allow=\"accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share\" allowfullscreen=\"\"></iframe>
                </div>
            ";
        }
        // line 102
...
";
    ...
    {
        return new Source("", "themes/custom/solar/templates/content/node--project-details--full.html.twig", "/var/www/html/adn.id.vn/d10test/web/themes/custom/solar/templates/content/node--project-details--full.html.twig");
    }
