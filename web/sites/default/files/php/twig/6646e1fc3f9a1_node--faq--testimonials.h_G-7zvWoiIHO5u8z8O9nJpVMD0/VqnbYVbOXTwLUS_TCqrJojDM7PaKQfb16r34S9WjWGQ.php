...
/* themes/custom/solar/templates/content/node--faq--testimonials.html.twig */
class __TwigTemplate_42800043898438c0613cb601ab2631e7 extends Template
{
    private $source;
    private $macros = [];
...
($context["view_mode"] ?? null)) ? (("node--view-mode-" . \Drupal\Component\Utility\Html::getClass($this->sandbox->ensureToStringAllowed(($context["view_mode"] ?? null), 82, $this->source)))) : (""))];
  ...
  <div class=\"single-review-area-soalri\">
    <img src=\"/themes/custom/solar/images/07.png\" class=\"quote\" alt=\"CME Solar\" />
    ...
    <div class=\"dsic\">
      ";
        // line 100
        echo $this->extensions['Drupal\Core\Template\TwigExtension']->renderVar($this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["node"] ?? null), "body", [], "any", false, false, true, 100), "value", [], "any", false, false, true, 100), 100, $this->source));
        echo "
    </div>
...
";
    ...
    {
        return "themes/custom/solar/templates/content/node--faq--testimonials.html.twig";
    }
    ...
    {
        return array (  78 => 100,  65 => 90,  56 => 85,  54 => 82,  53 => 81,  52 => 80,  51 => 79,  50 => 78,  49 => 77,  48 => 76,  47 => 73,  44 => 71,  42 => 70,  39 => 69,);
    }

    public function getSourceContext()
    {
        return new Source("", "themes/custom/solar/templates/content/node--faq--testimonials.html.twig", "/var/www/html/adn.id.vn/d10test/web/themes/custom/solar/templates/content/node--faq--testimonials.html.twig");
    }
    
    public function checkSecurity()
    {
        static $tags = array("set" => 70);
        static $filters = array("clean_class" => 70, "escape" => 85, "raw" => 100);
