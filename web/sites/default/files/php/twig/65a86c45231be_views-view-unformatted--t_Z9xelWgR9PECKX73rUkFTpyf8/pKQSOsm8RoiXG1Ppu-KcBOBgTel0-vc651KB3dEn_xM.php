...
/* themes/custom/solar/templates/views/views-view-unformatted--teammember.html.twig */
class __TwigTemplate_05a5a4e275e1fd4f1c11996c37700dec extends Template
{
    private $source;
    private $macros = [];
...
($context["default_row_class"] ?? null)) ? ("views-row col-lg-6 col-md-6 col-sm-12 col-12") : (""))];
            // line 29
            echo "  <div";
...
";
    ...
    {
        return "themes/custom/solar/templates/views/views-view-unformatted--teammember.html.twig";
    }
...
{% for row in rows %}
  {%
    set row_classes = [
      default_row_class ? 'views-row col-lg-6 col-md-6 col-sm-12 col-12',
    ]
  %}
...
{% endfor %}
", "themes/custom/solar/templates/views/views-view-unformatted--teammember.html.twig", "/var/www/html/adn.id.vn/d10test/web/themes/custom/solar/templates/views/views-view-unformatted--teammember.html.twig");
    }
