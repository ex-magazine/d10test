...
class __TwigTemplate_8cd41b76d3637c3f7398c7c9c71e2c1a extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    public function block_content($context, array $blocks = [])
    {
      ...
      <div class=\"row align-items-center\">
        ...
        // line 125
        echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, twig_trim_filter(twig_striptags($this->extensions['Drupal\Core\Template\TwigExtension']->renderVar($this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, ($context["content"] ?? null), "field_youtube", [], "any", false, false, true, 125), 125, $this->source)))), "html", null, true);
        echo "\" title=\"YouTube video player\" frameborder=\"0\" allow=\"accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share\" allowfullscreen></iframe>
                ...
                <div class=\"experiencea-area images\">
                    <h3 class=\"title\">";
        // line 129
        echo $this->extensions['Drupal\Core\Template\TwigExtension']->renderVar($this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, ($context["content"] ?? null), "field_years_experience", [], "any", false, false, true, 129), 129, $this->source));
        echo "</h3>
                    <p>";
        // line 130
        echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed((($__internal_compile_4 = twig_get_attribute($this->env, $this->source, ($context["content"] ?? null), "field_years_experience", [], "any", false, false, true, 130)) && is_array($__internal_compile_4) || $__internal_compile_4 instanceof ArrayAccess ? ($__internal_compile_4["#title"] ?? null) : null), 130, $this->source), "html", null, true);
        echo "</p>
                </div>
            </div>
        </div>
  ...
  ";
    ...
    {
        return array (  215 => 130,  211 => 129,  204 => 125,  194 => 118,  186 => 113,  173 => 103,  169 => 102,  165 => 101,  156 => 97,  148 => 92,  144 => 91,  130 => 80,  126 => 79,  106 => 62,  98 => 57,  93 => 55,  84 => 50,  80 => 49,  75 => 138,  73 => 49,  68 => 48,  61 => 46,  57 => 45,  53 => 44,  48 => 43,  46 => 40,  45 => 39,  44 => 38,  43 => 36,  40 => 34,);
    }
...
<div{{ attributes.addClass(classes) }}>
  {{ title_prefix }}
  {% if label %}  
    <span{{ title_attributes.addClass('stok-bg images-r left') }}>{{ label }}</span>
  {% endif %}
  {{ title_suffix }}
  {% block content %}
    <div{{ content_attributes.addClass('container') }}>
      <div class=\"row align-items-center\">
        <div class=\"col-lg-6\">
            <div class=\"solari-about-left-content\">
                <div class=\"title-area-left mt skew-up\">
                    {{ content.field_title_first|raw }}
                    <h2 class=\"title\">
                        {{ content.field_title|raw }}
                    </h2>
                </div>
                <div class=\"content-inner\">
                    <div class=\"disc\">
                    ...
                    <div class=\"power-soalr-area\">
                        <div class=\"single\">
                            ...
                            <div class=\"info\">
                                <h6 class=\"title\">{{ content.field_installed_capacity|raw}}</h6>
                                <span>{{ content.field_installed_capacity['#title'] }}</span>
                            </div>
                        </div>
                        <div class=\"single\">
                            <div class=\"icon\">
                            ...
                            <div class=\"info\">
                                <h6 class=\"title\">{{ content.field_save_world|raw}}</h6>
                                <span>{{ content.field_save_world['#title'] }}</span>
                            </div>
                        </div>
                    </div>
                    <div class=\"solari-about-button-area mt--40\">
                        <a href=\"{{ content.field_learn_more.0['#url'] }}\" class=\"rts-btn btn-primary\">{{ content.field_learn_more.0['#title'] }}</a>
                        <div class=\"call-button\">
                            <i class=\"fa-solid fa-phone\"></i>
                            <div class=\"info\">
                                <span>{{ content.field_callus247|raw }}</span>
                                <a href=\"tel:{{ content.field_mobile|render|striptags|trim  }}\">
                                    <h6 class=\"title\">{{ content.field_mobile|render|striptags|trim  }}</h6>
                                </a>
                            </div>
                        </div>
                    </div>
        ...
        <div class=\"col-lg-6 mt_md--50 mt_sm--40\">
            <div class=\"thumbnail-solari-about\">
                ...
                <div class=\"vedio-icone\">
                    ...
                    <div class=\"d-none\" id=\"youtube-embed\">
                        <iframe width=\"560\" height=\"315\" src=\"https://www.youtube.com/embed/{{ content.field_youtube|render|striptags|trim }}\" title=\"YouTube video player\" frameborder=\"0\" allow=\"accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share\" allowfullscreen></iframe>
                    </div>
                </div>
                <div class=\"experiencea-area images\">
                    <h3 class=\"title\">{{ content.field_years_experience|raw }}</h3>
                    <p>{{ content.field_years_experience['#title'] }}</p>
                </div>
            </div>
        </div>
    </div>
...
", "themes/custom/solar/templates/block/block--solar-aboutus.html.twig", "/var/www/html/adn.id.vn/d10test/web/themes/custom/solar/templates/block/block--solar-aboutus.html.twig");
    }
