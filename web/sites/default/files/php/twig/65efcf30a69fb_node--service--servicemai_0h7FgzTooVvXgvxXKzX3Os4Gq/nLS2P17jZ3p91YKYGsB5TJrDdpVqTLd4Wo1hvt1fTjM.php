...
<article";
        ...
        echo ">
  <div class=\"single-service-solari\" style=\"background-image: url('";
        // line 85
      ...
      <div class=\"icon-area\">
        ";
        // line 87
        echo $this->extensions['Drupal\Core\Template\TwigExtension']->renderVar($this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, ($context["content"] ?? null), "field_icon_svg", [], "any", false, false, true, 87), 87, $this->source));
        echo "
      </div>
      <a href=\"";
        // line 89
        echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed((($__internal_compile_0 = twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["content"] ?? null), "field_linkto", [], "any", false, false, true, 89), 0, [], "any", false, false, true, 89)) && is_array($__internal_compile_0) || $__internal_compile_0 instanceof ArrayAccess ? ($__internal_compile_0["#url"] ?? null) : null), 89, $this->source), "html", null, true);
        echo "\" rel=\"bookmark\">
          <h2 class=\"title\">";
        // line 90
 ...
 ";
    ...
    {
        return array (  85 => 93,  79 => 90,  75 => 89,  70 => 87,  65 => 85,  61 => 84,  58 => 83,  56 => 81,  55 => 80,  54 => 79,  53 => 78,  52 => 77,  51 => 76,  50 => 75,  49 => 73,  46 => 71,  44 => 70,  41 => 69,  39 => 1,);
    }
    ...
    public function checkSecurity()
    {
        ...
        static $filters = array("clean_class" => 70, "escape" => 84, "raw" => 87);
