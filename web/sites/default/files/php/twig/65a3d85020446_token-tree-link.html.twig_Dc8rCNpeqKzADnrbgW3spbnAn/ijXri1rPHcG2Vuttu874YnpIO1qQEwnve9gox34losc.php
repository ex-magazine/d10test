...
class __TwigTemplate_4eddeeffa092fb0870d1fd185c983dd5 extends Template
{
    private $source;
    private $macros = [];
...
{% if link -%}
  {{ link }}
{%- endif %}
", "modules/contrib/token/templates/token-tree-link.html.twig", "/var/www/html/adn.id.vn/d10test/web/modules/contrib/token/templates/token-tree-link.html.twig");
    }
