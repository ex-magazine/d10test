...
/* themes/custom/solar/templates/navigation/menu-local-tasks.html.twig */
class __TwigTemplate_c1b620b2b5a1aa549a22277210e0cdc1 extends Template
{
    private $source;
    private $macros = [];
...
";
        // line 17
        echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->extensions['Drupal\Core\Template\TwigExtension']->attachLibrary("solar/tabs"), "html", null, true);
        echo "
...
";
    ...
    {
        return "themes/custom/solar/templates/navigation/menu-local-tasks.html.twig";
    }
...
/**
 * @file
 * solar theme implementation to display primary and secondary local tasks.
 *
 * Available variables:
...
{% endif %}
", "themes/custom/solar/templates/navigation/menu-local-tasks.html.twig", "/var/www/html/adn.id.vn/d10test/web/themes/custom/solar/templates/navigation/menu-local-tasks.html.twig");
    }
