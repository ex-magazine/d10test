...
/* themes/custom/solar/templates/block/block--solar-views-block--banner-block-1.html.twig */
class __TwigTemplate_841bb16a5d69eb0764e8de05efaf535b extends Template
{
    private $source;
    private $macros = [];
...
($context["layout"] ?? null)) ? (("layout--" . \Drupal\Component\Utility\Html::getClass($this->sandbox->ensureToStringAllowed(($context["layout"] ?? null), 40, $this->source)))) : (""))];
  ...
  ";
        ...
        if (($context["label"] ?? null)) {
            // line 46
            echo "    <span";
            echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, ($context["title_attributes"] ?? null), "addClass", [0 => "block__title stok-bg images-r"], "method", false, false, true, 46), 46, $this->source), "html", null, true);
            echo ">";
...
";
    ...
    public function block_content($context, array $blocks = [])
    {
        ...
        // line 50
        echo "    <div";
        echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, ($context["content_attributes"] ?? null), "addClass", [0 => "block_content"], "method", false, false, true, 50), 50, $this->source), "html", null, true);
        echo ">     
      ";
        // line 51
  ...
  ";
    ...
    {
        return "themes/custom/solar/templates/block/block--solar-views-block--banner-block-1.html.twig";
    }
...
<div{{ attributes.addClass(classes) }}>
  {{ title_prefix }}
  {% if label %}
    <span{{ title_attributes.addClass('block__title stok-bg images-r') }}>{{ label }}</span>
  {% endif %}
  {{ title_suffix }}
  {% block content %}
    <div{{ content_attributes.addClass('block_content') }}>     
      {{ content }}       
    </div> 
  {% endblock %}
</div>
", "themes/custom/solar/templates/block/block--solar-views-block--banner-block-1.html.twig", "/var/www/html/adn.id.vn/d10test/web/themes/custom/solar/templates/block/block--solar-views-block--banner-block-1.html.twig");
    }
