...
class __TwigTemplate_c5c078ea63d94126609bde49fabc1fe3 extends Template
{
    private $source;
    private $macros = [];
...
<article{{ attributes.addClass(classes) }}>
    <div class=\"inner-main-wrapper-desk\">
        ...
        <div class=\"inner-content\">
            ...
            <div class=\"footer\">
                <h4 class=\"title\">{{ content.body|raw }}</h4>
                <a href=\"{{ url }}\" class=\"rts-btn btn-primary\">{{ content.field_clients|raw }}</a>
            </div>
        </div>
    </div>
</article>
", "themes/custom/solar/templates/content/node--landingpage--hero.html.twig", "/var/www/html/adn.id.vn/d10test/web/themes/custom/solar/templates/content/node--landingpage--hero.html.twig");
    }
