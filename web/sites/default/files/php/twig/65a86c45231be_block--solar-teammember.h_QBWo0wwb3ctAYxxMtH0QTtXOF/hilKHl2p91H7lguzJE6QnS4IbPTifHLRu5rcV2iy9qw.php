...
class __TwigTemplate_4e5e870f09c60cb1d3b4d0f43621a9fd extends Template
{
    private $source;
    private $macros = [];
...
($context["layout"] ?? null)) ? (("layout--" . \Drupal\Component\Utility\Html::getClass($this->sandbox->ensureToStringAllowed(($context["layout"] ?? null), 40, $this->source)))) : (""))];
  ...
  ";
        ...
        <img src=\"/themes/custom/solar/images/09.png\" alt=\"\">
    </div>
    <div class=\"shape-author-img-2 images-r\">
        <img src=\"/themes/custom/solar/images/10.png\" alt=\"\">
    </div>
</div>
";
    }
