...
class __TwigTemplate_1ce72d7c0f90678a64f63f44cbff0344 extends Template
{
    private $source;
    private $macros = [];
            ...
            <div class=\"row g-5\">
                <div class=\"col-xl-8 col-md-12 col-sm-12 col-12\">
                     {% if content.body is not empty %}
                        {{ content.body }} 
                    {% endif %}
                    {% if content.field_paragraphs is not empty %}
                        {{ content.field_paragraphs }}
                    {% endif %}
                    {% if content.field_viewreference is not empty %}
                        {{ content.field_viewreference }}  
                    {% endif %}
                    {% if content.field_pdf is not empty %}
                        {{ content.field_pdf }} 
                    {% endif %}
...
", "themes/custom/solar/templates/content/node--landingpage--sidebarright.html.twig", "/var/www/html/adn.id.vn/d10test/web/themes/custom/solar/templates/content/node--landingpage--sidebarright.html.twig");
    }
