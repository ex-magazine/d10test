...
class __TwigTemplate_a4d2081fad4fbe991ac38486cfe5894d extends Template
{
    private $source;
    private $macros = [];
...
($context["view_mode"] ?? null)) ? (("node--view-mode-" . \Drupal\Component\Utility\Html::getClass($this->sandbox->ensureToStringAllowed(($context["view_mode"] ?? null), 81, $this->source)))) : (""))];
    ...
    {
        return new Source("", "themes/custom/solar/templates/content/node--landingpage--makeappointment.html.twig", "/var/www/html/adn.id.vn/d10test/web/themes/custom/solar/templates/content/node--landingpage--makeappointment.html.twig");
    }
