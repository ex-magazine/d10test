...
/* themes/custom/solar/templates/views/views-view-unformatted--taxonomy-term.html.twig */
class __TwigTemplate_fd741b73dda9de1cbb0bac1a908cfb78 extends Template
{
    private $source;
    private $macros = [];
...
($context["default_row_class"] ?? null)) ? ("views-row col-lg-4 col-md-6 col-sm-12 col-12") : (""))];
            // line 29
            echo "  <div";
...
";
    ...
    {
        return "themes/custom/solar/templates/views/views-view-unformatted--taxonomy-term.html.twig";
    }
...
{% for row in rows %}
  {%
    set row_classes = [
      default_row_class ? 'views-row col-lg-4 col-md-6 col-sm-12 col-12',
    ]
  %}
...
{% endfor %}
", "themes/custom/solar/templates/views/views-view-unformatted--taxonomy-term.html.twig", "/var/www/html/adn.id.vn/d10test/web/themes/custom/solar/templates/views/views-view-unformatted--taxonomy-term.html.twig");
    }
