...
/* themes/custom/solar/templates/views/views-view-unformatted--servicemain.html.twig */
class __TwigTemplate_de0f1fa925c7fbdeabc9a32080539946 extends Template
{
    private $source;
    private $macros = [];
...
($context["default_row_class"] ?? null)) ? ("col-lg-3 col-md-6 cols-md-12 col-12") : (""))];
            // line 30
            echo "    <div";
  ...
  ";
    ...
    {
        return "themes/custom/solar/templates/views/views-view-unformatted--servicemain.html.twig";
    }
...
<div class=\"row g-24\">   
  {% for row in rows %}
    {%
      set row_classes = [
        default_row_class ? 'col-lg-3 col-md-6 cols-md-12 col-12',
      ]
    %}
  ...
  {% endfor %}
</div>", "themes/custom/solar/templates/views/views-view-unformatted--servicemain.html.twig", "/var/www/html/adn.id.vn/d10test/web/themes/custom/solar/templates/views/views-view-unformatted--servicemain.html.twig");
    }
