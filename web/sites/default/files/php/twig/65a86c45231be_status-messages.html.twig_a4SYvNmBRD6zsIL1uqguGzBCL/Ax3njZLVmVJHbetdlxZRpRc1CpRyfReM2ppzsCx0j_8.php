...
/* themes/custom/solar/templates/misc/status-messages.html.twig */
class __TwigTemplate_3a066de2e4041937e7f1269c69acfe9b extends Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        $macros = $this->macros;
        // line 22
        echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->extensions['Drupal\Core\Template\TwigExtension']->attachLibrary("solar/messages"), "html", null, true);
        echo "
            ...
            <h2 class=\"visually-hidden\">";
              ...
              <div class=\"messages__icon\">
                ...
                if (($context["type"] == "error")) {
                    // line 47
                    echo "                  ";
                    $this->loadTemplate("@solar/../images/error.svg", "themes/custom/solar/templates/misc/status-messages.html.twig", 47)->display($context);
                    // line 48
                    echo "                ";
                } elseif (($context["type"] == "warning")) {
                    // line 49
                    echo "                  ";
                    $this->loadTemplate("@solar/../images/warning.svg", "themes/custom/solar/templates/misc/status-messages.html.twig", 49)->display($context);
                    // line 50
                    echo "                ";
                } elseif (($context["type"] == "status")) {
                    // line 51
                    echo "                  ";
                    $this->loadTemplate("@solar/../images/status.svg", "themes/custom/solar/templates/misc/status-messages.html.twig", 51)->display($context);
                    // line 52
                    echo "                ";
                } elseif (($context["type"] == "info")) {
                    // line 53
                    echo "                  ";
                    $this->loadTemplate("@solar/../images/info.svg", "themes/custom/solar/templates/misc/status-messages.html.twig", 53)->display($context);
                    // line 54
                    echo "                ";
                }
                // line 55
...
";
    ...
    {
        return "themes/custom/solar/templates/misc/status-messages.html.twig";
    }
        ...
        <div class=\"messages__container\" data-drupal-selector=\"messages-container\"{% if type == 'error' %} role=\"alert\"{% endif %}>
          {% if status_headings[type] %}
            ...
            <h2 class=\"visually-hidden\">{{ status_headings[type] }}</h2>
              <div class=\"messages__icon\">
                {% if type == 'error' %}
                  {% include \"@solar/../images/error.svg\" %}
                {% elseif type == 'warning' %}
                  {% include \"@solar/../images/warning.svg\" %}
                {% elseif type == 'status' %}
                  {% include \"@solar/../images/status.svg\" %}
                {% elseif type == 'info' %}
                  {% include \"@solar/../images/info.svg\" %}
                {% endif %}
              </div>
            </div>
          {% endif %}
...
", "themes/custom/solar/templates/misc/status-messages.html.twig", "/var/www/html/adn.id.vn/d10test/web/themes/custom/solar/templates/misc/status-messages.html.twig");
    }
