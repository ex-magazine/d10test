...
/* themes/custom/solar/templates/content/node--landingpage--careers.html.twig */
class __TwigTemplate_00d71d5972a919f90fa5a038ff51c337 extends Template
{
    private $source;
    private $macros = [];
...
($context["view_mode"] ?? null)) ? (("node--view-mode-" . \Drupal\Component\Utility\Html::getClass($this->sandbox->ensureToStringAllowed(($context["view_mode"] ?? null), 81, $this->source)))) : (""))];
    ...
    ";
        // line 114
        if ( !twig_test_empty(twig_get_attribute($this->env, $this->source, ($context["content"] ?? null), "field_paragraphs", [], "any", false, false, true, 114))) {
            // line 115
            echo "        ";
            echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, ($context["content"] ?? null), "field_paragraphs", [], "any", false, false, true, 115), 115, $this->source), "html", null, true);
            echo "
    ";
        }
        // line 117
    ...
    <div class=\"rts-Product-area rts-section-gap\">        
        ...
        ";
        // line 120
        if ( !twig_test_empty(twig_get_attribute($this->env, $this->source, ($context["content"] ?? null), "field_viewreference", [], "any", false, false, true, 120))) {
            // line 121
            echo "            ";
            echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, ($context["content"] ?? null), "field_viewreference", [], "any", false, false, true, 121), 121, $this->source), "html", null, true);
            echo "  
        ";
        }
        // line 123
...
";
    ...
    {
        return "themes/custom/solar/templates/content/node--landingpage--careers.html.twig";
    }
    ...
    {
        return array (  155 => 127,  149 => 123,  143 => 121,  141 => 120,  137 => 119,  133 => 117,  127 => 115,  125 => 114,  109 => 103,  105 => 102,  99 => 101,  94 => 98,  86 => 97,  78 => 95,  76 => 94,  71 => 92,  62 => 86,  56 => 84,  54 => 81,  53 => 80,  52 => 79,  51 => 78,  50 => 77,  49 => 76,  48 => 75,  47 => 73,  44 => 71,  42 => 70,  39 => 69,);
    }

    public function getSourceContext()
    {
        return new Source("", "themes/custom/solar/templates/content/node--landingpage--careers.html.twig", "/var/www/html/adn.id.vn/d10test/web/themes/custom/solar/templates/content/node--landingpage--careers.html.twig");
    }
