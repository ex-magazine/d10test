...
/* themes/custom/solar/templates/content/node--news--card.html.twig */
class __TwigTemplate_a496727e61beeec15078d2efaec8308c extends Template
{
    private $source;
    private $macros = [];
...
";
        // line 73
        $context["classes"] = [0 => "node", 1 => "cpmpay-story-single-about", 2 => ("node--type-" . \Drupal\Component\Utility\Html::getClass($this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source,         // line 76
    ...
    <div class=\"body\">
        ...
        echo "</time></p>
            ...
            <div class=\"single\">
                ...
                ";
        // line 98
        echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, ($context["content"] ?? null), "field_subjects", [], "any", false, false, true, 98), 98, $this->source), "html", null, true);
        echo "
            </div>
        </div>
        <a href=\"";
        ...
        echo "\">
            <h5 class=\"title\">";
        // line 102
        echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, ($context["node"] ?? null), "label", [], "any", false, false, true, 102), 102, $this->source), "html", null, true);
        echo "</h5>
        </a>
        <a href=\"";
        // line 104
        ...
        echo "\" class=\"rts-btn btn-border radious-0\">
            ";
        // line 105
        echo $this->extensions['Drupal\Core\Template\TwigExtension']->renderVar(t("Read Details"));
        echo "<i class=\"fa-regular fa-arrow-up-right\"></i>
        </a>
    </div>
</article>
";
    ...
    {
        return "themes/custom/solar/templates/content/node--news--card.html.twig";
    }
    ...
    {
        return array (  101 => 105,  97 => 104,  92 => 102,  88 => 101,  82 => 98,  75 => 94,  66 => 88,  62 => 87,  56 => 85,  54 => 82,  53 => 81,  52 => 80,  51 => 79,  50 => 78,  49 => 77,  48 => 76,  47 => 73,  44 => 71,  42 => 70,  39 => 69,);
    }

    public function getSourceContext()
    {
        return new Source("", "themes/custom/solar/templates/content/node--news--card.html.twig", "/var/www/html/adn.id.vn/d10test/web/themes/custom/solar/templates/content/node--news--card.html.twig");
    }
    
    public function checkSecurity()
    {
        static $tags = array("set" => 70);
        static $filters = array("clean_class" => 70, "escape" => 85, "date" => 94, "t" => 105);
