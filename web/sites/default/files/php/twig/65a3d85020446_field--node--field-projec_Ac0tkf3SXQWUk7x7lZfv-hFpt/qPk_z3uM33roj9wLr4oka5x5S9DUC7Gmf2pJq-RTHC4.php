...
/* themes/custom/solar/templates/field/field--node--field-projectlogo--project-details.html.twig */
class __TwigTemplate_956885ba768647219c26760911d559f7 extends Template
{
    private $source;
    private $macros = [];
...
";
  ...
  ";
    ...
    <";
            // line 70
            echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, ((array_key_exists("label_tag", $context)) ? (_twig_default_filter($this->sandbox->ensureToStringAllowed(($context["label_tag"] ?? null), 70, $this->source), "h4")) : ("h4")), "html", null, true);
        ...
        ";
            ...
            // line 72
            echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, ((array_key_exists("label_tag", $context)) ? (_twig_default_filter($this->sandbox->ensureToStringAllowed(($context["label_tag"] ?? null), 72, $this->source), "h4")) : ("h4")), "html", null, true);
            echo ">
    ";
            // line 73
            if (($context["multiple"] ?? null)) {
...
";
    ...
    {
        return "themes/custom/solar/templates/field/field--node--field-projectlogo--project-details.html.twig";
    }
...
{% else %}
  <div{{ attributes.addClass(classes) }}>
    <{{ label_tag|default('h4') }}{{ title_attributes }}>
        {{ label }}
    </{{ label_tag|default('h4') }}>
    {% if multiple %}
...
{% endif %}
", "themes/custom/solar/templates/field/field--node--field-projectlogo--project-details.html.twig", "/var/www/html/adn.id.vn/d10test/web/themes/custom/solar/templates/field/field--node--field-projectlogo--project-details.html.twig");
    }
