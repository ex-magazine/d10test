...
[project page](https://www.drupal.org/project/ebt_tiles).

Submit bug reports and feature suggestions, or track changes in the
[issue queue](https://www.drupal.org/project/issues/ebt_tiles).
...
- If you use Field Layout module, it will automatically apply Layout Builder for
  ...
  block type fields:
  /admin/structure/block/block-content/manage/ebt_tiles/display/default
