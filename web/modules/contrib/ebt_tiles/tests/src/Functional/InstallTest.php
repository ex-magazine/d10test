...
namespace Drupal\Tests\ebt_tiles\Functional;
...
class InstallTest extends BrowserTestBase {
  ...
  public function testInstallation() {
    ...
    $this->assertFalse($this->moduleHandler->moduleExists('ebt_tiles'));
    ...
    $this->assertTrue($this->moduleInstaller->install(['ebt_tiles']));
    \Drupal::service('config.installer')->installDefaultConfig('module', 'ebt_tiles');
    $this->reloadServices();
    $this->assertTrue($this->moduleHandler->moduleExists('ebt_tiles'));
