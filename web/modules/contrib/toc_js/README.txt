 ...
 * Download the library TOC.js
   ...
   The complete path of shuffle file attended can be either :
   - libraries/toc/toc.min.js
   - libraries/toc/dist/toc.min.js
 * Check the status report
 * You can use composer to download and install the toc library. For this you
 ...
 * If using "wikimedia/composer-merge-plugin" in your project, you can also use the provided composer by adding it to your
   extra merge-plugin as such:
 "extra": {
     "merge-plugin": {
         "include": [
 ...
 * Finally the toc library can also be downloaded using npm asset-packagist using the following require :
