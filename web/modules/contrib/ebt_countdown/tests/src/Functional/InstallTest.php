...
namespace Drupal\Tests\ebt_countdown\Functional;
...
class InstallTest extends BrowserTestBase {
  ...
  public function testInstallation() {
    ...
    $this->assertFalse($this->moduleHandler->moduleExists('ebt_countdown'));
    ...
    $this->assertTrue($this->moduleInstaller->install(['ebt_countdown']));
    \Drupal::service('config.installer')->installDefaultConfig('module', 'ebt_countdown');
    $this->reloadServices();
    $this->assertTrue($this->moduleHandler->moduleExists('ebt_countdown'));
