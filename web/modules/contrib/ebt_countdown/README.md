...
Extra Block Types: Countdown module provides ability to add animated countdown
for specific date.

For a full description of the module, visit the
[project page](https://www.drupal.org/project/ebt_countdown).

Submit bug reports and feature suggestions, or track changes in the
[issue queue](https://www.drupal.org/project/issues/ebt_countdown).
...
After enable this project will be available a new block type called `EBT Countdown`

You can go at Structure » Block layout » Add custom block » EBT Countdown
...
After create your custom block with block type `EBT Countdown` you can place this
...
- If you use Field Layout module, it will automatically apply Layout Builder for
  ...
  block type fields:
  /admin/structure/block/block-content/manage/ebt_countdown/display/default


## FAQ

**Q: Can I use only one EBT block type,
for example EBT Slideshow, without other modules?**
