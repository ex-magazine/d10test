...
Extra Block Types: Video module provides ability to add single video
(Remote videos and local).

For a full description of the module, visit the
[project page](https://www.drupal.org/project/ebt_video).

Submit bug reports and feature suggestions, or track changes in the
[issue queue](https://www.drupal.org/project/issues/ebt_video).
...
- If you use Field Layout module, it will automatically apply Layout Builder for
  ...
  block type fields:
  /admin/structure/block/block-content/manage/ebt_video/display/default
