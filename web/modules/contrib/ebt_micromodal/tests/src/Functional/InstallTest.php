...
namespace Drupal\Tests\ebt_micromodal\Functional;
...
class InstallTest extends BrowserTestBase {
  ...
  public function testInstallation() {
    ...
    $this->assertFalse($this->moduleHandler->moduleExists('ebt_micromodal'));
    ...
    $this->assertTrue($this->moduleInstaller->install(['ebt_micromodal']));
    \Drupal::service('config.installer')->installDefaultConfig('module', 'ebt_micromodal');
    $this->reloadServices();
    $this->assertTrue($this->moduleHandler->moduleExists('ebt_micromodal'));
